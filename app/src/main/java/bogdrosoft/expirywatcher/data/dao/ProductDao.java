...
public interface ProductDao {
    ...
    //
    // statusFilter's values match bogdrosoft.expirywatcher.util.ProductStatusFilter's ordinals,
    ...
    //
    // sortMode's values match bogdrosoft.expirywatcher.util.SortOrder's ordinals. Each ORDER BY
